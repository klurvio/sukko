...
#        git clone https://github.com/adred-codev/odin-ws.git
```
...
#        git clone https://ghp_xxxxx@github.com/adred-codev/odin-ws.git
```
...
**Repository**: `https://github.com/adred-codev/odin-ws`  
